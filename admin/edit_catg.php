      ...
      <div class="col-md-12">
        <form role="form" class="form-horizontal" method="post" action="../inc/edit_category.php">
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" name="id" readonly="readonly" value="<?php echo $RowCatg[id];?>"></input>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-1 control-label">分类名称</label>
            <div class="col-sm-6">
              <input type="text" class="form-control" name="CatgName" value="<?php echo $RowCatg[CatgName];?>"></input>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <select class="form-control" name="CatgLv">
                <option value="<?php echo $RowCatg[CatgLv];?>"><?php echo $RowCatg[CatgLv];?></option>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <select class="form-control" name="CatgFatherId">
                <option value="<?php echo $RowCatg2[id];?>"><?php echo $RowCatg2[CatgName];?></option>
                <?php
